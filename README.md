...
- [1 - Install Anaconda 5.1](#Install Anaconda 5.1)
- [2 - Linux Ubuntu 16](#Linux Ubuntu 16)
    - [2.1 - Python para Windows](#2.1-Python para Windows)
- [3 - Instalando o Cuda e Cudnn com suporte a GPU](#3-Install CUDA e Cudnn com suporte a GPU)
4 - Cuda 8.0 GA2
5 - PATH 
